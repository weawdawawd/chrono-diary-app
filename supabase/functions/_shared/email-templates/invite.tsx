    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link> beizutreten.
          Klicke auf den Button unten, um die Einladung anzunehmen und dein Konto zu erstellen.
        </Text>
